    ...
    var _saveReply = function (topic, newReply) {
        ...
        $http.post("/api/v1/topics/" + topic.id + "/replies", newReply)
            .then(function (result) {
                ...
                if (topic.replies == null) topic.replies = []; // in case replies is empty ( first call)
...
myApp.controller('topicsController', ['$scope', '$http', 'dataService', function ($scope, $http, dataService) {
...
myApp.controller('newTopicController', ['$scope', '$http', '$window', 'dataService', function ($scope, $http, $window, dataService) {
    $scope.newTopic = {};
...
myApp.controller('singleTopicController', ['$scope', 'dataService', '$window', '$routeParams', function ($scope, dataService, $window, $routeParams) {
    $scope.topic = null;
    $scope.newReply = {};
